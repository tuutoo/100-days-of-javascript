...
function fetchTopStocks() {
  // Fetch data from api
  fetch('https://www.alphavantage.co/query?function=SECTOR&apikey=QNDTYQXZFRHO4QYL').then(response => {
    response.json()
...
function fetchStockData(symbol) {
  ...
  fetch(`https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=QNDTYQXZFRHO4QYL`).then(response => response.json()).then(data => {
